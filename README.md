...
##### 03 Apr '15 18h -  shed refactoring.
"Refactoring of code is done now. All storage facilities are now build on PICO_TREE instead of linked lists. Following image shows what it's look like when 11 hosts are up and running and are maintaining the mDNS-system. ![alt tag](https://raw.githubusercontent.com/jelledevleeschouwer/log/master/mdns_demo_8.png)"
